...
def render_interface():
    query = """SELECT p.nome, d.nome, av.comentario, av.cod FROM avaliacao_professor av
    ...
    print("===================== Minhas Avaliacoes de Professores =======================")
    if not avaliacoes:
    ...
    for i, avaliacao in enumerate(avaliacoes):
        print(f"[{i + 1}] ", "-> ", avaliacao[0], '|', avaliacao[1], '|', avaliacao[2])
    print("=================================================================")
    ...
    if option == 1:
        ...
        avaliacao = avaliacoes[codigo_avaliacao - 1][3]
